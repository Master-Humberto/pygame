...
pg_context_get_pref_path(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "ss", kwids, &org, &project)) {
        return NULL;
    }
...
static PyMethodDef _context_methods[] = {
    {"get_pref_path", pg_context_get_pref_path, METH_VARARGS | METH_KEYWORDS, DOC_PYGAMECONTEXTGETPREFPATH},
    {NULL, NULL, 0, NULL}
};
